...
OUTPUT="${OUTPUT:-${OUT_DIR}/same_prompt_eval_paper_smallmodel_k10_pilot3_b${BUDGET}.json}"
ANALYSIS_MD="${ANALYSIS_MD:-${OUT_DIR}/smallmodel_k10_pilot3_method_analysis.md}"
ANALYSIS_JSON="${ANALYSIS_JSON:-${OUT_DIR}/smallmodel_k10_pilot3_method_analysis.json}"

mkdir -p "$OUT_DIR"
export VLLM_USE_CHAT VLLM_MODEL_NAME

echo "[INFO] output dir: $OUT_DIR"
echo "[INFO] benchmark: paper_smallmodel_k10_pilot3"
...
echo "[INFO] completed smallmodel k10 pilot3 same-prompt evaluation"
