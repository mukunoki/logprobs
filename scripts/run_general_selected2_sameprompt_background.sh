...
LOG_PATH="${LOG_PATH:-${LOG_DIR}/general_selected2_sameprompt_${TS}_${NUM_TRIALS}trials_w${WORKERS}_mt${MAX_TOKENS}.log}"
PID_PATH="${PID_PATH:-${LOG_PATH%.log}.pid}"
META_PATH="${META_PATH:-${LOG_PATH%.log}.meta}"
RUN_SCRIPT="${SCRIPT_DIR}/run_general_selected2_sameprompt_all.sh"
...
echo "[INFO] started selected2 same-prompt evaluation"
echo "[INFO] pid: $PID_PATH"
echo "[INFO] log: $LOG_PATH"
