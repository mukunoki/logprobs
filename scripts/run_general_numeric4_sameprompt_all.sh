...
OUTPUT="${OUTPUT:-${OUT_DIR}/same_prompt_eval_paper_general_numeric4_b${BUDGET}.json}"
ANALYSIS_MD="${ANALYSIS_MD:-${OUT_DIR}/general_numeric4_method_analysis.md}"
ANALYSIS_JSON="${ANALYSIS_JSON:-${OUT_DIR}/general_numeric4_method_analysis.json}"

mkdir -p "$OUT_DIR"
export VLLM_USE_CHAT

echo "[INFO] output dir: $OUT_DIR"
echo "[INFO] benchmark: paper_general_numeric4"
...
echo "[INFO] completed numeric4 same-prompt evaluation"
